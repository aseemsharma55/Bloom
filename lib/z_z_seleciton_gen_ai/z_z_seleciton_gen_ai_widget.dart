...
import 'z_z_seleciton_gen_ai_model.dart';
export 'z_z_seleciton_gen_ai_model.dart';

class ZZSelecitonGenAiWidget extends StatefulWidget {
  const ZZSelecitonGenAiWidget({super.key});

  @override
  State<ZZSelecitonGenAiWidget> createState() => _ZZSelecitonGenAiWidgetState();
}

class _ZZSelecitonGenAiWidgetState extends State<ZZSelecitonGenAiWidget> {
  late ZZSelecitonGenAiModel _model;
                        ...
                        Container(
                          ...
                          child: Text(
                            valueOrDefault<String>(
                              _model.response,
                              'The Survivor: ZZ Plant could likely survive a mild apocalypse. Forget to water it? No problem. Barely any sunlight? It’s not bothered. It’s the ultimate plant for places where even cacti might think twice.',
                            ),
