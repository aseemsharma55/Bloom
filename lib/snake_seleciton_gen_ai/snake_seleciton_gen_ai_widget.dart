...
import 'snake_seleciton_gen_ai_model.dart';
export 'snake_seleciton_gen_ai_model.dart';

class SnakeSelecitonGenAiWidget extends StatefulWidget {
  const SnakeSelecitonGenAiWidget({super.key});

  @override
  State<SnakeSelecitonGenAiWidget> createState() =>
      _SnakeSelecitonGenAiWidgetState();
}

class _SnakeSelecitonGenAiWidgetState extends State<SnakeSelecitonGenAiWidget> {
  late SnakeSelecitonGenAiModel _model;
                        ...
                        Container(
                          ...
                          child: Text(
                            valueOrDefault<String>(
                              _model.response,
                              'The Bedroom Buddy: While most plants take a night off, the Snake Plant turns into a nocturnal oxygen bar, pumping out fresh O2 while you sleep. It’s like having a silent, leafy roommate who only helps without ever asking for anything in return!',
                            ),
