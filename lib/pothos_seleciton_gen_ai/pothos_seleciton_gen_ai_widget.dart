...
import 'pothos_seleciton_gen_ai_model.dart';
export 'pothos_seleciton_gen_ai_model.dart';

class PothosSelecitonGenAiWidget extends StatefulWidget {
  const PothosSelecitonGenAiWidget({super.key});

  @override
  State<PothosSelecitonGenAiWidget> createState() =>
      _PothosSelecitonGenAiWidgetState();
}

class _PothosSelecitonGenAiWidgetState
    extends State<PothosSelecitonGenAiWidget> {
  late PothosSelecitonGenAiModel _model;
                        ...
                        Container(
                          ...
                          child: Text(
                            valueOrDefault<String>(
                              _model.response,
                              'The Lazy Gardener’s Best Friend: If you forget it exists but remember it once a month, the Pothos will still be your cheerleader, purifying your air from those pesky chemicals like it’s on a covert mission!',
                            ),
